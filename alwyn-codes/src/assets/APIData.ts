...
export const Projects: ProjectContainer[] = [
	{
		projectId: "BI121",
		projectType: "BI",
		projectName: "Financial Results Analysis Paginated Report",
		projectSynopsis:
		...
		projectDetail: [
			"Key Components: Data cleaning and preparation using SQL to handle standardize formats, and merge multiple datasets. Creation of paginated reports in Power BI Report Builder to visualize key metrics and trends. Analysis of growth and retention over time, and commenting the overall growth of the brokerage.",
		],
		projectLink: "https://github.com/alwynbarnard/marulamed-paginated-reports",
		projectImageSrcs: [
			"../../Images/MarulaMedShowcase.png",
			"../../Images/Slide4.PNG",
			"../../Images/Slide5.PNG",
			"../../Images/Slide6.PNG",
			"../../Images/Slide7.PNG",
...
export const WorkHistoryData: WorkHistoryCompanies[] = [
	{
		position: "BI Developer (Contract)",
	...
	{
		position: "Intermediate Front End Developer (Contract)",
